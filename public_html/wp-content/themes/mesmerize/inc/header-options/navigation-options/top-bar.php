...
{
    if ($default == "menu") $to_print = "menu";
    else $to_print = get_theme_mod("header_top_bar_{$areaName}_content", $default);
    ...
    <div class="header-top-bar-area  <?php echo esc_attr($cols . " " . $areaName); ?>">
        <?php
          if ($to_print != "menu") {
            ...
            wp_nav_menu( array( 'theme_location' => 'seconddary' ) );
          }
        ?>
    </div>
    <?php
        ...
        <div class="header-top-bar <?php echo esc_attr($header_top_bar_class); ?>">
            <div class="<?php echo esc_attr(implode(' ', $classes)); ?>">
                <div class="header-top-bar-inner row middle-xs start-xs ">
                    ...
                    <?php mesmerize_print_top_bar_area('area-right', 'menu') ?> 
